 ...
 * Description: Página del servicio de Infraestructura ECHOS.
 *
 * @package Echos
 */
    ...
    <div class="srv-systems__inner">
      ...
      <div class="srv-systems__row">
        ...
        <div class="srv-systems__img">
          <img src="<?php echo $img; ?>baner1.jpg" alt="Sistema Losberger" />
        </div>
      </div>
      ...
      <div class="srv-systems__row srv-systems__row--reverse">
        <div class="srv-systems__img">
          <img src="<?php echo $img; ?>baner1.jpg" alt="Sistema Truss de Aluminio" />
        </div>
        <div class="srv-systems__text">
