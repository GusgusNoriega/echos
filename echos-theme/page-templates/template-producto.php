 ...
 * Description: Página de detalle de un producto ECHOS.
 *
 * @package Echos
 */
  ...
  <section class="prod-hero">
    ...
    <div class="container prod-hero__inner">
      <div class="prod-hero__copy">
        ...
        <a class="btn btn--orange" href="<?php echo $home; ?>#contacto">
          <span>Cotizar</span>
          <span class="btn__icon" aria-hidden="true">→</span>
        </a>
      </div>
      <div class="prod-hero__media">
        <img src="<?php echo $img; ?>baner1.jpg" alt="Esfera Cinética LED" class="prod-hero__img" />
      </div>
    </div>
  </section>
      ...
      <div class="prod-specs__inner">
        <div class="prod-specs__content">
          <div class="prod-specs__gallery">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Esfera Cinética detalle" class="prod-specs__img" />
        ...
        <div class="prod-ficha__inner">
          <div class="prod-ficha__media">
            <div class="prod-ficha__device">
              <img src="<?php echo $img; ?>baner1.jpg" alt="Ficha técnica Esfera Cinética" class="prod-ficha__img" />
            </div>
          </div>
      ...
      <div class="prod-gallery__grid">
        <div class="prod-gallery__row">
          <div class="prod-gallery__item prod-gallery__item--lg">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Experiencia 1" />
          </div>
          <div class="prod-gallery__item prod-gallery__item--sm">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Experiencia 2" />
          </div>
        </div>
        <div class="prod-gallery__row">
          <div class="prod-gallery__item prod-gallery__item--sm">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Experiencia 3" />
          </div>
          <div class="prod-gallery__item prod-gallery__item--lg">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Experiencia 4" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="prod-recomendados__slider">
        <div class="prod-recomendados__track">
          <div class="prod-recomendados__card">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Esfera Kinetic" class="prod-recomendados__img" />
          ...
          <div class="prod-recomendados__card">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Sistema Trust Aluminio" class="prod-recomendados__img" />
            <div class="prod-recomendados__info">
              <div class="prod-recomendados__text">
          ...
          <div class="prod-recomendados__card">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Panel LED" class="prod-recomendados__img" />
            <div class="prod-recomendados__info">
              <div class="prod-recomendados__text">
          ...
          <div class="prod-recomendados__card">
            <img src="<?php echo $img; ?>baner1.jpg" alt="Pantalla Holográfica" class="prod-recomendados__img" />
            <div class="prod-recomendados__info">
              <div class="prod-recomendados__text">
