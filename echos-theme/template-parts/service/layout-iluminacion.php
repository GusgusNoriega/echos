...
echos_service_render_additional_slider(
	isset( $service['additional_slider'] ) && is_array( $service['additional_slider'] ) ? $service['additional_slider'] : array(),
	isset( $service['additional'] ) && is_array( $service['additional'] ) ? $service['additional'] : array()
);
