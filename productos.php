    ...
    <div class="topbar topbar--static">
      <div class="container topbar__inner">
        ...
        <nav class="nav">
          ...
          <a href="productos.php" class="nav--active">Productos</a>
  ...
  <section class="productos-grid-section">
    <div class="container">
      <div class="productos-grid">
        ...
        <!-- Card 1 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Esfera Kinetic" class="producto-card__img" />
        ...
        <!-- Card 2 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Sistema Trust Aluminio" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
        ...
        <!-- Card 3 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Panel LED" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
        ...
        <!-- Card 4 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Pantalla Holográfica" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
        ...
        <!-- Card 5 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Iluminación Robótica" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
        ...
        <!-- Card 6 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Sistema de Audio" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
        ...
        <!-- Card 7 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Piso LED Interactivo" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
        ...
        <!-- Card 8 -->
        <a href="producto.php" class="producto-card">
          <img src="img/inicio/baner1.jpg" alt="Mapping Proyección" class="producto-card__img" />
          <div class="producto-card__info">
            <div class="producto-card__text">
